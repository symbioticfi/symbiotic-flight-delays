...
// CreateFlight is a paid mutator transaction binding the contract method 0xc40dd2da.
//
// Solidity: function createFlight(bytes32 airlineId, bytes32 flightId, uint48 scheduledTimestamp, uint48 epoch, bytes proof) returns()
func (_FlightDelays *FlightDelaysTransactor) CreateFlight(opts *bind.TransactOpts, airlineId [32]byte, flightId [32]byte, scheduledTimestamp *big.Int, epoch *big.Int, proof []byte) (*types.Transaction, error) {
	return _FlightDelays.contract.Transact(opts, "createFlight", airlineId, flightId, scheduledTimestamp, epoch, proof)
}

// CreateFlight is a paid mutator transaction binding the contract method 0xc40dd2da.
//
// Solidity: function createFlight(bytes32 airlineId, bytes32 flightId, uint48 scheduledTimestamp, uint48 epoch, bytes proof) returns()
func (_FlightDelays *FlightDelaysSession) CreateFlight(airlineId [32]byte, flightId [32]byte, scheduledTimestamp *big.Int, epoch *big.Int, proof []byte) (*types.Transaction, error) {
	return _FlightDelays.Contract.CreateFlight(&_FlightDelays.TransactOpts, airlineId, flightId, scheduledTimestamp, epoch, proof)
}

// CreateFlight is a paid mutator transaction binding the contract method 0xc40dd2da.
//
// Solidity: function createFlight(bytes32 airlineId, bytes32 flightId, uint48 scheduledTimestamp, uint48 epoch, bytes proof) returns()
func (_FlightDelays *FlightDelaysTransactorSession) CreateFlight(airlineId [32]byte, flightId [32]byte, scheduledTimestamp *big.Int, epoch *big.Int, proof []byte) (*types.Transaction, error) {
	return _FlightDelays.Contract.CreateFlight(&_FlightDelays.TransactOpts, airlineId, flightId, scheduledTimestamp, epoch, proof)
}
